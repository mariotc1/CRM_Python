...
class AssistantBubbleDudas(QDialog):
    """
    Burbuja en modo Qt.Popup que describe las funcionalidades de la vista de Dudas.
    """
    ...
    def init_ui(self):
        ...
        # Título
        title_label = QLabel("<h2 style='color:#ECF0F1;'>Asistente: Sección de Dudas</h2>")
        title_label.setAlignment(Qt.AlignCenter)

        # Texto con las funcionalidades
        info_label = QLabel(
            "<p style='color:#ECF0F1; font-size:14px;'>"
            "En esta sección puedes gestionar todas tus dudas y consultas de manera eficiente:<br><br>"
            "• <b>Crear Duda:</b> Registra nuevas dudas o preguntas que tengas.<br>"
            "• <b>Responder Dudas:</b> Proporciona respuestas a las dudas registradas.<br>"
            "• <b>Eliminar Dudas:</b> Borra dudas que ya hayan sido resueltas o que no sean necesarias.<br>"
            "• <b>Buscar y Filtrar:</b> Utiliza los filtros para encontrar dudas específicas.<br><br>"
            "Además, puedes categorizar las dudas, asignarlas a miembros del equipo y mantener un seguimiento óptimo de las consultas de tus clientes.<br>"
            "¡Utiliza esta herramienta para mantener una comunicación clara y eficiente con tus clientes y mejorar su satisfacción!</p>"
        )
